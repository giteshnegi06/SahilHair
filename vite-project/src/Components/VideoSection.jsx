  ...
  return (
    <section className="py-32 bg-luxury-bg border-b border-luxury-text/5">
      <div className="max-w-7xl mx-auto px-6 flex flex-col justify-center items-center">
        ...
        <div className="flex flex-wrap gap-y-10 gap-x-20 justify-center items-center  ">
          {videos.map((video, index) => (
            <motion.div
              ...
              className={`relative w-78 lg:w-90 xl:w-120  xl:h-60 aspect-video overflow-hidden border border-luxury-text/10 shadow-2xl group rounded-3xl 
      ...
      `}
        ...
        <div className="mt-10 flex flex-col md:flex-row justify-between items-center gap-8 border-t border-luxury-text/5 pt-12 w-full">
